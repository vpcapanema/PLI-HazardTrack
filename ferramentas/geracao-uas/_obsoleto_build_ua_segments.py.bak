...
Fonte unica da verdade: ferramentas/relatorios-plano-contingencia/ra_official.py
...
a fonte canonica e ra_official.py (lookup por km).
"""
...
from ra_official import (  # noqa: E402  # pylint: disable=wrong-import-position
    RA_GEO_BY_SEGMENT,
    RA_HID_BY_SEGMENT,
    _max_class,
)
